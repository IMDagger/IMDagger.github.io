...
.. cut:: а как?
   ...
   .. smart-code-block:: xml
       ...
       <web-app xmlns="http://java.sun.com/xml/ns/javaee"
         ...
         $$strong$$<param-value>/WEB-INF/dl-servlet.xml</param-value>$$/strong$$
         </context-param>
         <listener>
         <listener-class>
   ...
   **org.springframework.web.servlet.DispatcherServlet** для обработки
   ...
   .. smart-code-block:: xml
       ...
       <beans xmlns="http://www.springframework.org/schema/beans"
         ...
         $$strong$$<import resource="/dl-context/main-context.xml" />$$/strong$$
       </beans>
   ...
   .. smart-code-block:: xml
       ...
       <bean id="dataSource" class="$$strong$$org.apache.tomcat.dbcp.dbcp.BasicDataSource$$/strong$$" destroy-method="close">
         <property name="driverClassName" value="$$strong$$net.sourceforge.jtds.jdbc.Driver$$/strong$$" />
         <property name="url" value="$$strong$$jdbc:jtds:sqlserver://dl-test:1030/dldb$$/strong$$" />
         <property name="username" value="$$strong$$пользователь-базы$$/strong$$" />
         <property name="password" value="$$strong$$пароль$$/strong$$" />
       </bean>
       ...
       $$strong$$<bean id="cellDAO" class="results.CellDao">
       ...
       <bean id="simpleUrlHandler" class="org.springframework.web.servlet.handler.SimpleUrlHandlerMapping">
         ...
         <props>
         $$strong$$<prop key="results">resultsTableController</prop>$$/strong$$
         </props>
         </property>
       </bean>
       <bean id="viewResolver" class="org.springframework.web.servlet.view.InternalResourceViewResolver">
         ...
         <property name="prefix"><value>/WEB-INF/pages/jsp/</value></property>
   ...
   .. smart-code-block:: java
      ...
      ...
      ... new ModelAndView("$$strong$$index$$/strong$$")
      ...
